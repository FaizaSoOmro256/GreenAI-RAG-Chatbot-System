"""
Green AI: An Intelligent RAG Chatbot for Sindh's Sustainable Climate Actions
...
st.sidebar.markdown("---")
st.sidebar.caption("© 2026 Green AI")
...
st.sidebar.markdown("Green AI helps users learn about climate actions in Sindh, calculate their carbon footprint, and discover offset options.")
