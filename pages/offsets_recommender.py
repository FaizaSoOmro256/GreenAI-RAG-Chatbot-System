"""
Offsets Recommender module for GreenAI.
        ...
        for i, project in enumerate(filtered_projects):
            ...
            with col2:
                ...
                def generate_pdf_report(project):
                    ...
                    elements.append(Paragraph(
                        "To support this project, contact the GreenAI team at greenai@example.com or visit our website.",
                        normal_style
                    ))
                    ...
                    elements.append(Paragraph(
                        "This report was generated by GreenAI - Sustainable Climate Actions for Sindh",
                        ParagraphStyle(
                            'Footer',
