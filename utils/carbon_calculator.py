...
def create_carbon_footprint_pdf(result: CarbonFootprintResult) -> bytes:
    ...
    This report was generated by the GreenAI Carbon Footprint Calculator, which helps users understand and 
...
def create_shareable_image(result: CarbonFootprintResult) -> bytes:
    ...
    try:
        ...
        fig.text(0.5, 0.02, 'Generated with GreenAI Carbon Calculator • www.greenai-sindh.org', 
...
# Integration with GreenAI main app
