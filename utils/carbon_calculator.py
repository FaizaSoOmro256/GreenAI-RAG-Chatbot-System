...
def create_carbon_footprint_pdf(result: CarbonFootprintResult) -> bytes:
    ...
    This report was generated by the Ecosphere AI Carbon Footprint Calculator, which helps users understand and 
...
def create_shareable_image(result: CarbonFootprintResult) -> bytes:
    ...
    try:
        ...
        fig.text(0.5, 0.02, 'Generated with Ecosphere AI Carbon Calculator • www.ecosphereai-sindh.org', 
                        ...
                        if image_bytes:
                            ...
                            **How to share:**
                            ...
                            2. Post it on your social media with hashtags:
                               #CarbonFootprint #ClimateAction #EcosphereAI
                            """)
                        else:
...
# Integration with Ecosphere AI main app
